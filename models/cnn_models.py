"""
In this script different convolutional neural networks are created for
    ...
    def __init__(
        ...
        if model_name == "resnet18":
            ...
            raise NotImplementedError(
                "This model is not implemented. Try other models."
            )

    def forward(self, x):
        """
        forward pass of CNN.
        :param x: input tensor of shape (batch-size, channels, height, width)
        :return:
        """
        return self.model(x)
